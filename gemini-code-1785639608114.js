...
// 執行方式: node server.js → 點擊終端機顯示的網址即可開啟頁面
...
function buildPayment() {
  const params = {
    ...
    ReturnURL: "https://example.com/payment-result", // 測試環境可留空或填任意 URL
...
server.listen(PORT, () => {
  ...
  console.log("==========================================");
  console.log("🚀 綠界付款 Demo 伺服器已成功啟動！");
  console.log(`👉 請按住 Ctrl/Cmd 點擊網址前往操作： ${url}`);
  console.log("==========================================");
});